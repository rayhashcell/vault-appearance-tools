...
![深色主题下带彩虹文件夹、文件类型图标和扩展名徽标的文件浏览器](docs/images/file-explorer-dark.png)

### 浅色主题文件浏览器

![浅色主题下带彩虹文件夹、文件类型图标和扩展名徽标的文件浏览器](docs/images/file-explorer-light.png)

### 简体中文设置页

![Vault Appearance Tools 简体中文设置页](docs/images/settings-zh-cn.png)

### 英文设置页

![Vault Appearance Tools 英文设置页](docs/images/settings-en.png)
